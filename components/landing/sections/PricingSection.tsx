      ...
      <div className="mt-10 grid gap-4 md:grid-cols-2">
        <div className="relative overflow-hidden rounded-3xl bg-white/10 p-6 ring-1 ring-white/10">
          <div className="flex items-center justify-between">
            ...
            <span className="rounded-full bg-white/10 px-3 py-1 text-xs text-white/70 ring-1 ring-white/10">Generous</span>
          </div>
          ...
          <div className="mt-6">
            <a
              href={onlineUrl}
              className="inline-flex h-12 w-full items-center justify-center rounded-2xl bg-white/10 px-5 text-sm font-semibold text-white ring-1 ring-white/10 hover:bg-white/15 transition"
            >
              Try online (beta)
            </a>
          </div>
        ...
        <div className="relative overflow-hidden rounded-3xl bg-white/10 p-6 ring-1 ring-white/10 shadow-[0_20px_60px_rgba(0,0,0,0.30)]">
          ...
          <div className="relative mt-6 grid gap-3 sm:grid-cols-2">
            <a
              ...
              className="inline-flex h-12 items-center justify-center rounded-2xl bg-white/10 px-5 text-sm font-semibold text-white ring-1 ring-white/10 hover:bg-white/15 transition"
            >
              Get the app
            </a>
            <button
              type="button"
              onClick={() => showToast("Pro is coming!", "We’ll enable Pro after beta stability is confirmed.")}
              className="inline-flex h-12 items-center justify-center rounded-2xl bg-white px-5 text-sm font-semibold text-black hover:bg-white/90 transition"
            >
              Notify me
            </button>
          </div>

          <p className="relative mt-3 text-xs text-white/60">Pricing goal: student-friendly, transparent, no dark patterns.</p>
        </div>
      </div>
    </section>
  );
