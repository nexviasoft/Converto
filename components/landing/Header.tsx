        ...
        <div className="flex items-center gap-2">
          {googlePlayUrl ? (
            <a
              ...
              className="hidden rounded-2xl bg-white/10 px-4 py-2 text-sm text-white ring-1 ring-white/10 transition hover:bg-white/15 sm:inline-flex"
            >
              Get the app
            </a>
          ) : (
            <button
              ...
              className="hidden cursor-not-allowed rounded-2xl bg-white/10 px-4 py-2 text-sm text-white/70 ring-1 ring-white/10 transition sm:inline-flex"
            >
          ...
          <a
            href={onlineUrl}
            className="relative overflow-hidden rounded-2xl bg-white px-4 py-2 text-sm font-semibold text-black transition hover:bg-white/90"
          >
