...
export default function FormatsPage() {
  ...
  return (
    <main className="min-h-screen bg-[#151233] text-white">
      ...
      <div className="mx-auto max-w-[1450px] px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 xl:grid-cols-[240px_minmax(0,1fr)_240px] 2xl:grid-cols-[260px_minmax(0,1fr)_260px]">
          <aside className="hidden xl:block">
            <AdUnit
              slot={AD_SLOTS.LEFT_RAIL}
              density="normal"
